        ...
        if not self.silent:
            ...
            match error:
                case Errors.DOUBLE_WHITESPACE:
                    ...
                    self.term.print_yellow("Tip: Language specification specifies only a single whitespace seperating each keywords (except string literals).\n")
                case Errors.UNTERM_STR:
                    self.term.print(f"Unterminated string literal on")
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Language specification prevents multi-line string.\n")
                ...
                case Errors.UNTERM_MULTILINE_COMMENT:
                    ...
                    self.term.print(f"\t.\n\t.\n\t.")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Multiline comments are ended by 'TLDR'.\n")
                case Errors.EXPECTED_HAI:
                    self.term.print(f"Expected 'HAI' but found '{reference_token.lexeme}' instead on")
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Lolcode programs starts with 'HAI' and ends with 'KTHXBYE'.\n")
                case Errors.EXPECTED_WAZZUP:
                    self.term.print(f"Expected 'WAZZUP' but found '{reference_token.lexeme}' instead on")
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Variable declaration section should always be after HAI.\n")
                case Errors.EXPECTED_BUHBYE:
                    self.term.print(f"Expected 'BUHBYE' but found '{reference_token.lexeme}' instead on")
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Variable declaration section must be closed with 'BUHBYE'.\n")
                ...
                case Errors.EXPECTED_VARIDENT:
                    ...
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Declare variable using 'I HAS A <varident>'.\n")
                case Errors.UNEXPECTED_NEWLINE:
                    ...
                    self.term.print_yellow(f"line {reference_token.line}.\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n\n")
                    self.term.print_yellow("Tip: Lolcode commands are separated by a newline. Soft command breaks are not currently supported.\n")
                ...
                case Errors.INVALID_VAR_VALUE:
                    ...
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Supported variable values are literals, variable identifier (reference), or expression.\n") 
                case Errors.UNEXPECTED_OPERAND:
                    ...
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Expressions in lolcode are in prefix notation.\n")
                case Errors.INVALID_STRING_CONT_ARG:
                    ...
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Only literals and variables are allowed in string concatenation.\n")
                case Errors.INVALID_ARG_SEPARATOR:
                    ...
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Operations with multiple arities are separated by 'AN'.\n")
                ...
                case Errors.NESTING_IF:
                    ...
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Nesting IF statements are not yet supported.\n")
                case Errors.UNTERM_IF:
                    ...
                    self.term.print(f"\t{context_token.line} | {self.get_code_line(context_token.line)}\n\n")
                    self.term.print_yellow("Tip: IF-THEN statements are terminated by 'OIC'.\n")
                case Errors.NESTING_SC:
                    self.term.print(f"Nesting switch-case statements found on")
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Nesting switch-case statements are not yet supported.\n")
                case Errors.MISSING_CASE:
                    self.term.print(f"Unexpected token '{reference_token.lexeme}' found at line")
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Switch-case requires at least one non-default case.\n")
                case Errors.INVALID_CASE_VAL:
                    self.term.print(f"Invalid value '{reference_token.lexeme}' for a case key found at line")
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Literals are the only keys allowed for cases.\n")
                case Errors.UNTERM_SC:
                    ...
                    self.term.print(f"\t{context_token.line} | {self.get_code_line(context_token.line)}\n\n")
                    self.term.print_yellow("Tip: Switch-case statements are terminated by 'OIC'.\n")
                case Errors.EMPTY_CASE:
                    self.term.print(f"Empty case found on")
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Case fallthrough is not currently supported..\n")
                case Errors.NESTING_LP:
                    self.term.print(f"Nesting loop statements found on")
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Nesting loop statements are not yet supported.\n")
                case Errors.INVALID_LOOPIDENT:
                    self.term.print(f"Unexpected token '{reference_token.lexeme}' found at line")
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Loop identifiers must follow the same conventions as a variable identifier.\n")
                case Errors.INVALID_STEP:
                    ...
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Loop step can be either UPPIN (increment by 1) or NERFIN (decrement by 1).\n")
                case Errors.INVALID_COUNTER:
                    ...
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Variables are the only valid loop counters.\n")
                case Errors.INVALID_LOOP_COND:
                    ...
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Loop conditions follow the format (TIL | WILE) <expr>.\n")
                case Errors.UNTERM_LOOP:
                    ...
                    self.term.print(f"\t{context_token.line} | {self.get_code_line(context_token.line)}\n\n")
                    self.term.print_yellow("Tip: Loop statements are terminated by 'IM OUTTA YR <loop_label>'.\n")
                case Errors.NESTING_MULT_ART:
                    self.term.print(f"Nesting multiple arity operations found at line")
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Expression with infinite arities can not be nested.\n")
                case Errors.INVALID_FUNCIDENT:
                    self.term.print(f"Unexpected token '{reference_token.lexeme}' found at line")
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Function identifiers must follow the same conventions as a variable identifier.\n")
                case Errors.INVALID_FUNCTION_PARAM:
                    ...
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Variable identifiers are the only allowed function parameters.\n")
                case Errors.UNTERM_FUNC:
                    ...
                    self.term.print(f"\t{context_token.line} | {self.get_code_line(context_token.line)}\n\n")
                    self.term.print_yellow("Tip: Function declarations are terminated by 'IF U SAY SO'.\n")
                case Errors.ONLY_FUNC_DEC_ALLOWED:
                    self.term.print(f"Unexpected token '{reference_token.lexeme}' found at line")
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.self.term.print_yellow("Tip: Only function declarations are allowed before 'WAZZUP'.\n")
                case Errors.FUNCTION_OVERLOADING:
                    ...
                    self.term.print_yellow("Tip: Function overloading is not currently supported.\n")
                case Errors.NESTING_FUNC:
                    self.term.print(f"Nesting function declarations found at")
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Functions can't be defined inside functins.\n")
                case Errors.INVALID_FUNC_DECLARATION:
                    self.term.print(f"Illegal function declaration found at")
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Functions can only be declared between the 'HAI' and 'KTHXBYE' sections and must not be inside flow control statements.\n")
                ...
                case Errors.INVALID_RETVAL:
                    ...
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Valid return values are expression, literal, and variables (must be in the parameter).\n")
                case Errors.INVALID_FUNCTION_CALL:
                    ...
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Use the function identifier to call a function.\n")
                case Errors.INVALID_FUNCTION_ARG:
                    ...
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Function arguments can be a literal, variable, or an expression.\n")
                case Errors.VISIBLE_SEP_EXPECTED:
                    ...
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: Visible arguments are separated by '+'.\n")
                case Errors.UNTERM_MULT_ARITY:
                    self.term.print(f"Unterminated '{reference_token.lexeme}' expression found at")
                    self.term.print_yellow(f"line {reference_token.line}.\n\n")
                    self.term.print(f"\t{reference_token.line} | {self.get_code_line(reference_token.line)}\n")
                    self.term.print_yellow("Tip: 'ALL OF' and 'ANY OF' operations are terminated by 'MKAY'.\n")
