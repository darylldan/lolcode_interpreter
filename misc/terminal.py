...
class Terminal():
    def __init__(self, root, input_buffer_tk) -> None:
        ...
        self.input_buffer = ""
        self.text_widget = tk.Text(terminalFrame, borderwidth=0, highlightthickness=0, width=30, height=10)
        ...
        self.input_field = tk.Text(terminalFrame, height=10, borderwidth=0, highlightthickness=0, width=30)
